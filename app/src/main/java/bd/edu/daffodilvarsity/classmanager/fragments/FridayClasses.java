 ...
 */
public class FridayClasses extends Fragment {

    private FirebaseAuth mAuth;

    private CollectionReference mFridayRef;
    ...
    private void initializeVariables(View view) {
        ...
        mFridayRef = db.collection("main_campus/classes_day/friday");
    ...
    private void loadDataStudent() {
        ...
        for (HashMap.Entry<String, String> entry : courses.entrySet()) {
            ...
            taskList.add(
                    mFridayRef.whereEqualTo("courseCode", courseCode)
    ...
    private void loadTeacherClasses(String teacherInitial) {
        ...
        mFridayRef.whereEqualTo("teacherInitial", teacherInitial)
                .orderBy("priority")
                .get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    @Override
