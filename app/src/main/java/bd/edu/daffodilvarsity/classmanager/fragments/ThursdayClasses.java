...
public class ThursdayClasses extends Fragment {
    ...
    private CollectionReference mThursdayRef;
    ...
    private void initializeVariables(View view) {
        ...
        mThursdayRef = db.collection("main_campus/classes_day/thursday");
    ...
    private void loadDataStudent() {
        ...
        for (HashMap.Entry<String, String> entry : courses.entrySet()) {
            ...
            taskList.add(
                    mThursdayRef.whereEqualTo("courseCode", courseCode)
